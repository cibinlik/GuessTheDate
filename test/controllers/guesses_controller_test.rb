...
class GuessesControllerTest < ActionController::TestCase
  ...
  test "should create guess" do
    assert_difference('Guess.count') do
      post :create, guess: { answer: @guess.answer, delta: @guess.delta, information_id: @guess.information_id, kind: @guess.kind, score: @guess.score, user_id: @guess.user_id }
    end
  ...
  test "should update guess" do
    patch :update, id: @guess, guess: { answer: @guess.answer, delta: @guess.delta, information_id: @guess.information_id, kind: @guess.kind, score: @guess.score, user_id: @guess.user_id }
    assert_redirected_to guess_path(assigns(:guess))
  end
