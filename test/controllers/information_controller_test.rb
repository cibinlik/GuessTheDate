...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { day: @information.day, info: @information.info, month: @information.month, user_id: @information.user_id, year: @information.year }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { day: @information.day, info: @information.info, month: @information.month, user_id: @information.user_id, year: @information.year }
    assert_redirected_to information_path(assigns(:information))
  end
